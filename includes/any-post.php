...
class blcPostTypeOverlord {
	...
	*/
	 ...
	 * Also prefix the link url with a Wayback machine url to provide a link
	 * for the url Internet Archive
	 *
	...
	// @cogdog note $link needs to be passed by reference if it needs to be changed
